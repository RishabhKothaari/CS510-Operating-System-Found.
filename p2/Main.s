...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0x98ded8d1 (decimal -1730225967)
	set	_packageName,r2
	set	0x98ded8d1,r3
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_313 = &_Global_myLock2
	set	_Global_myLock2,r1
	store	r1,[r14+-224]
!   Send message Init
	load	[r14+-224],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_myLock3
	set	_Global_myLock3,r1
	store	r1,[r14+-220]
!   Send message Init
	load	[r14+-220],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_315 = &_Global_myLock4
	set	_Global_myLock4,r1
	store	r1,[r14+-216]
!   Send message Init
	load	[r14+-216],r1
	load	[r1],r2
...
_P_Main_ForkMonitor:
	...
	jmp	_Method_P_Main_ForkMonitor_5	! 20:	testEatOrNot
	.word	0
! 
! Class descriptor:
! 
...
!   _temp_712 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_711  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_707:
!   Perform the FOR-LOOP termination test
!   if p > _temp_712 then goto _Label_710		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_740 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-80]
!   Move address of _temp_740 [p ] into _temp_741
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_739 = *_temp_741  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-84]
!   if _temp_739 != 1 then goto _Label_736		(int)
	load	[r14+-84],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_736
...
!   _temp_744 = _temp_745 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   Move address of _temp_743 [_temp_744 ] into _temp_746
!     make sure index expr is >= 0
	load	[r14+-64],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_742 = *_temp_746  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-72]
!   if _temp_742 == 2 then goto _Label_736		(int)
	load	[r14+-72],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_736
...
!   _temp_749 = _temp_750 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-44]
!   Move address of _temp_748 [_temp_749 ] into _temp_751
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_747 = *_temp_751  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-52]
!   if _temp_747 == 2 then goto _Label_736		(int)
	load	[r14+-52],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_736
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: *_temp_753 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-28],r2
	store	r1,[r2]
! SEND STATEMENT...
